...
\paragraph{Threaded joints along the $x$ axis} The loads acting on section A the $x$ axis are represented in figure \ref{fig:sectionxA}.\\
\begin{figure}[bth]
    \centering
    \begin{subfigure}{0.32\linewidth}
    	\centering \includegraphics[width=4.5cm]{xyA_assex} 
	\end{subfigure}
	\begin{subfigure}{0.32\linewidth}
		\centering \includegraphics[width=4.5cm]{xzA_assex}
	\end{subfigure}
	\begin{subfigure}{0.32\linewidth}
		\centering \includegraphics[width=2cm]{yzA_assex} 
	\end{subfigure}    
...
\paragraph{Threaded joints along the $z$ axis}  The loads acting on section A the $z$ axis are represented in figure \ref{fig:sectionxA}.\\
\begin{figure}[h!]
    \centering
	\includegraphics[width=12cm]{assez_A}
...
\begin{figure}[h!]
    \centering
    \begin{subfigure}{0.32\linewidth}
    	\centering \includegraphics[width=4cm]{pivotjoint.jpg}
    \end{subfigure}
	\begin{subfigure}{0.32\linewidth}
		\centering \includegraphics[width=4cm]{pivot1} 
	\end{subfigure}
	\begin{subfigure}{0.32\linewidth}
		\centering \includegraphics[width=4cm]{pivot2}
	\end{subfigure}    
...
\begin{SCfigure}[1.5][h!]
	\centering
	\includegraphics[width=10cm]{loadssectionD}
...
Moreover, the verifications for crushing and punching provide the minimum member ultimate strength, $\sigma_{uts,m} > 0.23 MPa$, value much smaller than the chosen member's UTS.
